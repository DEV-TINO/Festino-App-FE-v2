...
const ClubDetail: React.FC<ClubProps> = ({ club }) => {
  ...
  return (
    <div
      ...
      className="cursor-pointer flex py-5 rounded-3xl w-[170px] xs:w-[210px] sm:w-[230px] border-2 flex-col items-center gap-2.5 shadow-4xl border-primary-900-light-16 text-primary-900"
    >
      <div
      ...
      <button className="text-white w-[120px] h-[30px] rounded-full text-xs bg-primary-700">공연 정보 상세보기</button>
    </div>
  );
};
